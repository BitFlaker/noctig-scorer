...
pub fn view(_app: &NoctiG) -> Element<'_, Message> {
    column![
        ...
        text("This section is not yet implemented. In the future a collection of documentations, guides, FAQs, etc. should be accessible here").style(theme::text_secondary),
